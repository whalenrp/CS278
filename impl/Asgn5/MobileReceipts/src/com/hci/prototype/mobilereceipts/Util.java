...
public final class Util {
	...
	public static String getReceiptText(final Context ctxt, final String filename){
		...
		if (!(new File(DATA_PATH + "tessdata/" + lang + ".traineddata")).exists()) {
			...
			try {
				...
				final AssetManager assetManager = ctxt.getAssets();
				final InputStream in = assetManager.open(lang + ".traineddata");
				final OutputStream out = new FileOutputStream(DATA_PATH
		...
		try {
			...
			final int exifOrientation = exif.getAttributeInt(

/* Adapted from http://www.jython.org/jythonbook/en/1.0/JythonAndJavaIntegration.html */
...
public class JythonObjectFactory {
 ...
 public JythonObjectFactory(Class interfaceType, String moduleName, String className, String[] sysPathAppends) {

     PySystemState sys = Py.getSystemState();

     for (String s : sysPathAppends) {
        sys.path.append(new PyString(s));
     }
